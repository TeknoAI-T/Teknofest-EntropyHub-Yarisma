...
const translations = {
  tr: {
    "nav-start": "Başlangıç", "nav-architecture": "Mimari", "nav-verify": "Doğrulama",
  ...
  en: {
    "nav-start": "Getting started", "nav-architecture": "Architecture", "nav-verify": "Verification",
...
const textTargets = {
  "a[href='#baslangic']": "nav-start", "a[href='#mimari']": "nav-architecture", "a[href='#dogrulama']": "nav-verify",
